...
/* ── palette (dark-mode adaptation of the green/amber editorial design) ── */
const G900 = "#052e16"; // deepest fill backgrounds in SVG
const G700 = "#15803d"; // primary structure — nodes, borders
const G500 = "#22c55e"; // bright emerald — numbers / section labels
const G300 = "#86efac"; // lighter accent on dark
const AMB  = "#d97706"; // amber — quarterly highlights
const AMB2 = "#fbbf24"; // amber lighter — milestone callouts
const TER  = "#ea580c"; // warm orange/terracotta — deliverables, QC gate
const GOOD = "#16a34a"; // done / accepted state

/* ── shared style tokens ─────────────────────────────────────────────── */
const mono = { fontFamily: "var(--font-mono)" } as const;
const sectionNum: React.CSSProperties = {
  ...mono, fontSize: 12, color: G500, fontWeight: 600,
...
const infographLabel: React.CSSProperties = {
  ...
  color: G500, fontWeight: 600, marginBottom: 10, display: "block",
};
    ...
    <div className="min-h-screen pt-12 pb-20">
      <div className="container-custom">
        ...
        <section style={{ paddingBottom: 48 }}>
          <span style={{ ...mono, fontSize: 11, textTransform: "uppercase", letterSpacing: "0.14em", color: G700, fontWeight: 500, marginBottom: 28, display: "inline-block" }}>
          ...
          <h1 style={{ fontWeight: 700, fontSize: "clamp(36px, 5vw, 62px)", lineHeight: 1.05, letterSpacing: "-0.025em", color: "var(--text)", marginBottom: 24 }}>
            ...
            <em style={{ fontStyle: "italic", color: G500 }}>data intelligence platform</em>{" "}
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              ...
              <em style={{ fontStyle: "italic", color: G500 }}>single source of analytical truth</em>.
            </h2>
          </div>
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              Four quarters. <em style={{ fontStyle: "italic", color: G500 }}>Four phase shifts</em>. One continuous build.
            </h2>
            <p style={sectionLead}>
          ...
          <div style={infograph}>
            ...
            <div style={{ overflowX: "auto" }}>
              <svg viewBox="0 0 1100 400" style={{ width: "100%", minWidth: 700, height: "auto", display: "block" }}>
                ...
                {/* Endpoints */}
                <circle cx="60"   cy="100" r="10" fill={G900}/>
                <text x="60"   y="78" textAnchor="middle" style={svgLabel({ fill: G500, fontWeight: 600 })}>Start</text>
                <circle cx="1060" cy="100" r="10" fill={G900}/>
                <text x="1060" y="78" textAnchor="middle" style={svgLabel({ fill: G500, fontWeight: 600 })}>Close</text>

                {/* Spine */}
                <line x1="70" y1="100" x2="1050" y2="100" stroke={G700} strokeWidth="2"/>

                {/* Phase nodes */}
                {[170, 400, 630, 860].map((cx, i) => (
                  <g key={cx}>
                    <circle cx={cx} cy="100" r="14" fill={svgBg} stroke={G700} strokeWidth="2.5"/>
                    <text x={cx} y="105" textAnchor="middle" style={svgNum({ fontSize: 11, fill: G500 })}>0{i + 1}</text>
                  </g>
                ))}

                {/* Connector lines down */}
                {[170, 400, 630, 860].map(cx => (
                  <line key={cx} x1={cx} y1="118" x2={cx} y2="148" stroke={G300} strokeWidth="1.5"/>
                ))}
                ...
                {[
                  ...
                  <g key={cx}>
                    <rect x={x} y="155" width="200" height="200" fill={svgBg} stroke={G700} strokeWidth="1.5" rx="4"/>
                ...
                {/* Phase color bars */}
                <rect x="70"  y="383" width="200" height="3" fill={G700}/>
                <rect x="300" y="383" width="200" height="3" fill={G300}/>
                <rect x="530" y="383" width="200" height="3" fill={AMB}/>
                <rect x="760" y="383" width="200" height="3" fill={TER}/>
              </svg>
            </div>
          </div>
        </section>
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              ...
              <em style={{ fontStyle: "italic", color: G500 }}>visible from outside the team</em>.
            </h2>
            <p style={sectionLead}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                ...
                style={{
                  background: "var(--bg-card)", border: "1px solid var(--line)",
                  borderLeft: `3px solid ${G700}`, borderRadius: "var(--radius-md)", padding: "28px 24px",
                }}
              >
                <div style={{ ...mono, fontSize: 11, color: AMB, textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 600, marginBottom: 8 }}>{q}</div>
                ...
                <div style={{ ...mono, fontSize: 13, fontStyle: "italic", color: G500, paddingTop: 12, borderTop: "1px dashed var(--line)" }}>
                  ★ {milestone}
                </div>
              </div>
            ))}
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              ...
              <em style={{ fontStyle: "italic", color: G500 }}>Each one earns its place</em>.
            </h2>
            <p style={sectionLead}>
          ...
          <div style={infograph}>
            ...
            <div style={{ overflowX: "auto" }}>
              <svg viewBox="0 0 1100 400" style={{ width: "100%", minWidth: 700, height: "auto", display: "block" }}>
                ...
                <text x="20" y="68"  style={svgLabel({ fill: G500, fontWeight: 600 })}>Project Backlog</text>
                ...
                <rect x="0" y="260" width="180" height="100" fill={svgBg} stroke={AMB} rx="4"/>
                <text x="20" y="288" style={svgLabel({ fill: AMB, fontWeight: 600 })}>Sprint Backlog</text>
                ...
                {/* Divider */}
                <line x1="220" y1="220" x2="1080" y2="220" stroke={G300} strokeWidth="1" strokeDasharray="4 4"/>

                {/* Deliverable */}
                <ellipse cx="620" cy="70" rx="120" ry="34" fill={G700}/>
                <text x="620" y="68" textAnchor="middle" style={svgText({ fill: "#FFFFFF", fontWeight: 600, fontSize: 14 })}>Deliverable</text>
                <text x="620" y="86" textAnchor="middle" style={svgMute({ fontSize: 10, fontStyle: "italic", fill: G300 })}>Outcome the client receives</text>

                {/* Lines to activities */}
                <line x1="560" y1="104" x2="380" y2="148" stroke={G700} strokeWidth="1.5"/>
                <line x1="680" y1="104" x2="860" y2="148" stroke={G700} strokeWidth="1.5"/>

                {/* Activities */}
                {[{ cx: 380, label: "Activity 1" }, { cx: 860, label: "Activity 2" }].map(({ cx, label }) => (
                  <g key={cx}>
                    <ellipse cx={cx} cy="170" rx="105" ry="28" fill={G500}/>
                    <text x={cx} y="168" textAnchor="middle" style={svgText({ fill: "#FFFFFF", fontWeight: 600, fontSize: 13 })}>{label}</text>
                    <text x={cx} y="184" textAnchor="middle" style={svgMute({ fontSize: 10, fontStyle: "italic", fill: G900 })}>Body of work</text>
                  </g>
                ))}

                {/* Lines to tasks */}
                {[[320, 280], [440, 470], [800, 770], [920, 950]].map(([x1, x2], i) => (
                  <line key={i} x1={x1} y1="198" x2={x2} y2="240" stroke={AMB} strokeWidth="1.5"/>
                ))}

                {/* Tasks */}
                {[{ x: 220, label: "Task 1" }, { x: 410, label: "Task 2" }, { x: 710, label: "Task 3" }, { x: 890, label: "Task 4" }].map(({ x, label }) => (
                  <g key={x}>
                    <rect x={x} y="245" width="120" height="44" fill={AMB} rx="22"/>
                ...
                <text x="220" y="342" style={svgMute({ fontSize: 11 })}>
                  <tspan style={{ fontWeight: 600, fill: G500 }}>Deliverable. </tspan>What the client signs off — the contractual unit.
                </text>
                <text x="220" y="360" style={svgMute({ fontSize: 11 })}>
                  <tspan style={{ fontWeight: 600, fill: G500 }}>Activity. </tspan>A body of work inside a deliverable; how the team groups effort.
                </text>
                <text x="220" y="378" style={svgMute({ fontSize: 11 })}>
                  <tspan style={{ fontWeight: 600, fill: AMB }}>Task. </tspan>An atomic unit a team member can absorb inside a sprint.
                </text>
              </svg>
            </div>
          </div>
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              ...
              <em style={{ fontStyle: "italic", color: G500 }}>set every downstream decision</em>.
            </h2>
            <p style={sectionLead}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {deliverables.map(({ icon: Icon, title, desc }) => (
              <div
                ...
                style={{
                  background: "var(--bg-card)", border: "1px solid var(--line)",
                  borderLeft: `3px solid ${TER}`,
                  borderRadius: `0 var(--radius-md) var(--radius-md) 0`,
                  padding: "20px 24px", display: "flex", gap: 14, alignItems: "flex-start",
                }}
              >
                <Icon size={22} style={{ color: TER, flexShrink: 0, marginTop: 2 }} />
                <div>
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              ...
              <em style={{ fontStyle: "italic", color: G500 }}>tight on purpose</em>.
            </h2>
            <p style={sectionLead}>
          ...
          <div style={infograph}>
            ...
            <div style={{ overflowX: "auto" }}>
              <svg viewBox="0 0 1100 420" style={{ width: "100%", minWidth: 700, height: "auto", display: "block" }}>
                ...
                {/* Row 01: Business requirements */}
                <circle cx="40" cy="74" r="14" fill={G700}/>
                ...
                {/* DE: 5h */}
                <rect x="660" y="60" width="35" height="28" fill={G300} rx="2"/>
                <text x="712" y="79" style={svgText({ fontSize: 13, fontWeight: 600 })}>5</text>
                {/* DS: 20h */}
                <rect x="800" y="60" width="140" height="28" fill={G700} rx="2"/>
                ...
                {/* Row 02: Technical requirements */}
                <circle cx="40" cy="135" r="14" fill={G700}/>
                ...
                <rect x="660" y="121" width="35" height="28" fill={G300} rx="2"/>
                <text x="712" y="140" style={svgText({ fontSize: 13, fontWeight: 600 })}>5</text>
                <rect x="800" y="121" width="140" height="28" fill={G700} rx="2"/>
                ...
                {/* Row 03: Cloud cost */}
                <circle cx="40" cy="196" r="14" fill={G700}/>
                ...
                {/* DE: 10h */}
                <rect x="660" y="182" width="70" height="28" fill={G300} rx="2"/>
                ...
                {/* Row 04: Kick-off (PM only) */}
                <circle cx="40" cy="257" r="14" fill={AMB}/>
                ...
                {/* PM: 10h */}
                <rect x="960" y="243" width="70" height="28" fill={AMB} rx="2"/>
                ...
                <text x="712"  y="325" textAnchor="middle" style={svgNum({ fontSize: 24, fill: G500 })}>20<tspan style={{ fontSize: 14, fill: "var(--text-body)" }}>h</tspan></text>
                <text x="870"  y="325" textAnchor="middle" style={svgNum({ fontSize: 24, fill: G500 })}>40<tspan style={{ fontSize: 14, fill: "var(--text-body)" }}>h</tspan></text>
                <text x="1010" y="325" textAnchor="middle" style={svgNum({ fontSize: 24, fill: AMB  })}>10<tspan style={{ fontSize: 14, fill: "var(--text-body)" }}>h</tspan></text>

                {/* Footer annotation */}
                <rect x="20" y="360" width="1060" height="50" fill={svgBg} stroke={svgBorder} rx="4"/>
                <text x="40" y="382" style={svgText({ fontSize: 12, fontWeight: 600, fill: G500 })}>Sprint 1 = 70h total committed across three roles, no buffer.</text>
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              ...
              <em style={{ fontStyle: "italic", color: G500 }}>does on each day</em>.
            </h2>
            <p style={sectionLead}>
            ...
            <div style={{ overflowX: "auto" }}>
              <svg viewBox="0 0 1100 460" style={{ width: "100%", minWidth: 720, height: "auto", display: "block" }}>
                ...
                {[
                  ...
                  <text key={x} x={x} y="54" textAnchor="middle" style={svgLabel({ fill: G300, fontWeight: 600 })}>{label}</text>
                ))}
                ...
                {[
                  {
                    ...
                    cells: [
                      { x: 80,  text: "Prep biz interview", border: G300 },
                      { x: 240, text: "Cloud cost research",  border: AMB },
                      { x: 400, text: "Template adaptation",  border: TER },
                      { x: 565, text: "Prep tech interview",  border: G300 },
                      { x: 725, text: "Cloud cost research",  border: AMB },
                      { x: 885, text: "Template adaptation",  border: TER },
                    ],
                  },
                  {
                    ...
                    cells: [
                      { x: 80,  text: "Prep biz interview", border: G300 },
                      { x: 240, text: "Cloud cost research", border: AMB },
                      { x: 400, text: "Comms strategy",      border: TER },
                      { x: 565, text: "Prep tech interview", border: G300 },
                      { x: 725, text: "Cloud cost research", border: AMB },
                      { x: 885, text: "Comms strategy",      border: TER },
                    ],
                  },
                  {
                    ...
                    cells: [
                      { x: 80,  text: "Prep biz interview",   border: G300 },
                      { x: 240, text: "Cloud proposal draft",  border: AMB },
                      { x: 400, text: "Project schedule",      border: TER },
                      { x: 565, text: "Prep tech interview",   border: G300 },
                      { x: 725, text: "Cloud proposal draft",  border: AMB },
                      { x: 885, text: "Project schedule",      border: TER },
                    ],
                  },
                ...
                {/* Thu — stakeholder day (highlighted) */}
                <text x="20" y="227" style={svgText({ fontWeight: 600, fill: TER })}>Thu</text>
                {[
                  ...
                  <g key={x}>
                    <rect x={x} y="205" width="160" height="36" fill={svgBg} stroke={TER} strokeWidth="1.5" rx="3"/>
                    <text x={x + 80} y="227" textAnchor="middle" style={svgText({ fontSize: 10, fontWeight: 600, fill: TER })}>{text}</text>
                  </g>
                ))}
                {/* Group discussion bands */}
                <rect x="80"  y="250" width="480" height="28" fill={svgBg} stroke={G300} strokeDasharray="3 2" rx="3"/>
                <text x="320" y="268" textAnchor="middle" style={svgMute({ fontSize: 10, fontStyle: "italic", fill: G300 })}>Group discussion · share findings across team</text>
                <rect x="565" y="250" width="480" height="28" fill={svgBg} stroke={G300} strokeDasharray="3 2" rx="3"/>
                <text x="805" y="268" textAnchor="middle" style={svgMute({ fontSize: 10, fontStyle: "italic", fill: G300 })}>Group discussion · share findings across team</text>

                {/* Fri — documentation */}
                <text x="20" y="307" style={svgText({ fontWeight: 600 })}>Fri</text>
                <rect x="80"  y="290" width="480" height="36" fill={svgBg} stroke={AMB} rx="3"/>
                <text x="320" y="312" textAnchor="middle" style={svgText({ fontSize: 11, fontWeight: 600 })}>Documentation of results · all roles</text>
                <rect x="565" y="290" width="480" height="36" fill={svgBg} stroke={AMB} rx="3"/>
                ...
                {[
                  { x: 20,  fill: svgBg, stroke: G300,              label: "Prep · research"    },
                  { x: 180, fill: svgBg, stroke: AMB,               label: "Proposal drafting"  },
                  { x: 340, fill: svgBg, stroke: TER,               label: "PM activities"      },
                  { x: 480, fill: svgBg, stroke: TER,               label: "Stakeholder time",  strokeWidth: "1.5" },
                  { x: 630, fill: svgBg, stroke: G300, dash: "3 2", label: "Team sync"          },
                ].map(({ x, fill, stroke, label, strokeWidth, dash }) => (
                  <g key={x}>
                    <rect x={x} y="379" width="18" height="14" fill={fill} stroke={stroke} strokeWidth={strokeWidth ?? "1"} strokeDasharray={dash}/>
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              ...
              <em style={{ fontStyle: "italic", color: G500 }}>six columns, one flow</em>.
            </h2>
            <p style={sectionLead}>
              ...
              <svg viewBox="0 0 1100 360" style={{ width: "100%", minWidth: 700, height: "auto", display: "block" }}>
                <defs>
                  <marker id="dip-kanban-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
                    <path d="M 0 0 L 10 5 L 0 10 z" fill={G500}/>
                  </marker>
                </defs>

                {/* Roadmap zone */}
                <rect x="20" y="20" width="320" height="260" fill={svgBg} stroke={G700} strokeWidth="1.5" rx="4"/>
                <text x="35" y="44" style={svgLabel({ fill: G500, fontWeight: 600 })}>Roadmap</text>

                {/* Project Backlog col header */}
                <rect x="35" y="60" width="140" height="28" fill={G700} rx="2"/>
                <text x="105" y="78" textAnchor="middle" style={svgText({ fill: "#FFFFFF", fontSize: 11, fontWeight: 600 })}>Project Backlog</text>
                {[
                  { label: "Initial Diagnostic",    bold: true  },
                  { label: "System Specification",  bold: true  },
                  { label: "DL Ingestion",           bold: true  },
                  { label: "+ activities (refined)", bold: false },
                ].map(({ label, bold }, i) => (
                  <g key={i}>
                    <rect x="35" y={100 + i * 30} width="140" height="24" fill={svgBg} stroke={G700} rx="2" opacity={bold ? 1 : 0.5}/>
                    <text x="43" y={116 + i * 30} style={svgText({ fontSize: 10, fontWeight: bold ? 600 : 400, fill: bold ? G300 : "var(--text-muted)" })}>{label}</text>
                  </g>
                ))}

                {/* Sprint Backlog col header */}
                <rect x="185" y="60" width="140" height="28" fill={AMB} rx="2"/>
                ...
                {["Prep biz interviews", "Biz interviews", "Cloud cost research", "Cloud proposal", "Kick-off comms plan"].map((label, i) => (
                  <g key={i}>
                    <rect x="185" y={100 + i * 30} width="140" height="24" fill={svgBg} stroke={AMB} rx="2"/>
                    <text x="193" y={116 + i * 30} style={svgMute({ fontSize: 10 })}>{label}</text>
                  </g>
                ))}

                {/* Zone separator arrow */}
                <line x1="345" y1="200" x2="363" y2="200" stroke={G500} strokeWidth="2" markerEnd="url(#dip-kanban-arrow)"/>

                {/* Sprint Execution zone */}
                <rect x="375" y="20" width="705" height="260" fill={svgBg} stroke={svgBorder} strokeWidth="1" rx="4"/>
                <text x="390" y="44" style={svgLabel({ fill: G500, fontWeight: 600 })}>Sprint Execution</text>

                {/* To Do */}
                <rect x="390" y="60" width="155" height="28" fill={G300} rx="2"/>
                <text x="467" y="78" textAnchor="middle" style={svgText({ fill: G900, fontSize: 11, fontWeight: 600 })}>To Do</text>
                {[
                  { label: "Task: pull cost data",    sub: "DE · 2h"  },
                  { label: "Task: define interview Q", sub: "DS · 15h" },
                ].map(({ label, sub }, i) => (
                  <g key={i}>
                    <rect x="390" y={100 + i * 48} width="155" height="40" fill={svgBg} stroke={G300} rx="2"/>
                ...
                {/* In Progress */}
                <rect x="555" y="60" width="155" height="28" fill={G700} rx="2"/>
                ...
                {[
                  ...
                  <g key={i}>
                    <rect x="555" y={100 + i * 48} width="155" height="40" fill={svgBg} stroke={G700} strokeWidth="1.5" rx="2"/>
                ...
                {/* Review (QC) */}
                <rect x="720" y="60" width="155" height="28" fill={TER} rx="2"/>
                <text x="797" y="78" textAnchor="middle" style={svgText({ fill: "#FFFFFF", fontSize: 11, fontWeight: 600 })}>Review (QC)</text>
                <rect x="720" y="100" width="155" height="40" fill={svgBg} stroke={TER} strokeWidth="1.5" rx="2"/>
                <text x="730" y="118" style={svgMute({ fontSize: 10 })}>Task: cost research v1</text>
                <text x="730" y="132" style={{ ...mono, fontSize: 9, fill: TER, fontWeight: 600 } as React.CSSProperties}>DE · awaiting tech-ref review</text>

                {/* Done */}
                <rect x="885" y="60" width="180" height="28" fill={GOOD} rx="2"/>
                ...
                {[
                  ...
                  <g key={i}>
                    <rect x="885" y={100 + i * 48} width="180" height="40" fill={G900} stroke={GOOD} rx="2"/>
                    <text x="895" y={118 + i * 48} style={{ ...svgMute({ fontSize: 10 }), textDecoration: "line-through" }}>{label}</text>
                    <text x="895" y={132 + i * 48} style={svgMute({ fontSize: 9, fill: GOOD, fontWeight: 600 })}>{sub}</text>
                  </g>
                ))}

                {/* Bottom annotation */}
                <rect x="20" y="295" width="1060" height="50" fill={svgBg} stroke={svgBorder} rx="4"/>
                <text x="35" y="317" style={svgText({ fontSize: 12, fontWeight: 600, fill: G500 })}>Two acceptance layers — Definition of Done (internal) + Acceptance Criteria (client).</text>
        ...
        <section style={{ paddingBottom: 64 }}>
          <div style={{ marginBottom: 40 }}>
            ...
            <h2 style={sectionH2}>
              ...
              <em style={{ fontStyle: "italic", color: G500 }}>years later</em>.
            </h2>
            <p style={sectionLead}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{ background: "var(--ink-3)", borderLeft: `3px solid ${G700}`, borderRadius: `0 var(--radius-md) var(--radius-md) 0`, padding: "28px 32px" }}>
              <div style={{ ...mono, fontSize: 10, textTransform: "uppercase", letterSpacing: "0.14em", color: G500, fontWeight: 600, marginBottom: 14 }}>Carried forward</div>
          ...
          >
            <span
              style={{
                ...
                color: AMB, opacity: 0.4, lineHeight: 1, fontFamily: "Georgia, serif",
              }}
            >
              &ldquo;
            </span>
            <p style={{ fontSize: 22, lineHeight: 1.5, fontStyle: "italic", color: G300 }}>
              The platform was the deliverable.{" "}
              The{" "}
              <strong style={{ color: AMB2, fontStyle: "normal", fontWeight: 600 }}>planning model</strong>{" "}
