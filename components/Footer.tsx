      ...
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            ...
            <p className="text-dark-300">Florianópolis - Santa Catarina</p>
          </div>
          <div>
            <h3 className="mb-4 text-lg font-semibold text-white">Phone</h3>
            <a
              href="tel:+5555996695092"
        ...
        <div className="mt-8 border-t border-dark-700 pt-8 text-center text-sm text-dark-400">
          <p>© {currentYear} Daniel Chaves. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
